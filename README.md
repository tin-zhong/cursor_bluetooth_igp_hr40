...
```text
dist/hr40-offline-fitness-v1.1.1.apk
```
...
如果安装后界面没有变化，请先卸载旧版 App，再安装 `dist/hr40-offline-fitness-v1.1.1.apk`。
打开 App 后标题应显示 **HR40 离线运动监测 v1.1.1**，并能看到“运动时长”和“力量训练”区域。
