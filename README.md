...
```text
dist/hr40-offline-fitness-v3.1.0.apk
```
...
- `y=1`：周一强制体重更新 + Room 数据库存储与原始数据导出
- `z=0`：无单独 UI 版本变化

## 安装注意

如果安装后界面没有变化，请先卸载旧版 App，再安装 `dist/hr40-offline-fitness-v3.1.0.apk`。
打开 App 后标题应显示 **HR40 离线运动监测 v3.1.0**。
